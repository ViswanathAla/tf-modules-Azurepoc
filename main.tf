terraform {
  backend "azurerm" {
    ...
    storage_account_name = "sbhrbvljhbhtoethouthe"
    container_name       = "tfstate"
    access_key = "w+VxM5pCPwxn6fZqgjzGeD3dcJs1CxEztFzDW5J00fhpESInLGFkeo2ll6AgmM2ks/UWZVFpy6iC+ASt1lkqlQ=="
  }
}
# -----------------------------------------------------------------------------
...
module "resource_groups" {
  ...
  resource_group_name     = "EIS-DW-POC-RG" #var.resource_group_name
...
module "Keyvault" { 
   ...
   resource_group_name        = module.resource_groups.resource_group_name
   location                   = module.resource_groups.resource_group_location
   key_vault_name             = "xdeasdudhufsghkh"
